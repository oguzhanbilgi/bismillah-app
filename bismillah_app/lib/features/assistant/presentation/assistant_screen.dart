...
/// Bismillah Asistanı sohbet ekranı (TASK 059 §11).
///
/// Kaynaklı, deterministik cevaplar; fetva makamı DEĞİLDİR. Boş durumda
/// önerilen sorular; sohbet hâlinde kullanıcı/asistan kartları, kaynak
/// kartları ve ilgili Learn içerikleri. Ses/mikrofon YOKTUR.
      ...
      children: [
        AppCard(
          ...
          child: Column(
            ...
            children: [
              AppText(l10n.assistantTitle, token: AppTextStyleToken.h2),
          ...
          child: ExcludeSemantics(
            child: DecoratedBox(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(child: AppText(question)),
                    Icon(
                      isRtl
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          ...
          child: message.isUser
              ...
              : _AssistantCard(message: message),
        );
      },
    );
  }
...
class _AssistantCard extends ConsumerWidget {
  ...
  String _badge(AppLocalizations l10n) => switch (message.answerType) {
      ...
      child: Column(
        ...
        children: [
          ...
          if (message.sources.isNotEmpty) ...[
            const SizedBox(height: AppSpacing.s4),
            _BlockTitle(l10n.assistantSourcesTitle),
            const SizedBox(height: AppSpacing.s2),
            for (final source in message.sources) _SourceCard(source: source),
          ],
          if (message.relatedArticleIds.isNotEmpty &&
              response != null &&
              response.relatedArticles.isNotEmpty) ...[
            const SizedBox(height: AppSpacing.s4),
            _BlockTitle(l10n.assistantRelatedTitle),
            const SizedBox(height: AppSpacing.s2),
            Wrap(
          ...
          if (response?.shouldOfferOfficialGuidance ?? false) ...[
            if (response?.officialGuidanceUrl case final String url) ...[
              const SizedBox(height: AppSpacing.s4),
              AppButton(
                label: l10n.assistantOfficialGuidanceCta,
                variant: AppButtonVariant.secondary,
                onPressed: () => _openOfficial(context, ref, url),
              ),
            ],
          ],
        ],
...
class _SourceCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final l10n = AppLocalizations.of(context);
    final tokens = IslamicVisualTokens.of(context);
    final isTranslation = source.originalLanguage == 'tr';
      ...
      child: DecoratedBox(
        ...
        child: Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // Resmî kaynak künyesi (kurum) — Diyanet etiketi.
              AppText(
                source.institution,
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          AppText('$index.', color: tokens.spiritualGreenStrong),
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: AppSpacing.s2),
            // Boş mesaj/loading sırasında gönderim kilitli.
