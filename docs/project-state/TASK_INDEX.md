...
| TASK 084 | **NEXT** | CP10 | Missed-day recovery and gentle rollover — owns day navigation, deferred here by TASK 083. Open sequencing note: generation is still not connected to persistence or onboarding completion, so the Today plan section shows Empty in practice, and no dedicated task is named for that wiring | roadmap CP10 | run TASK 084 |
