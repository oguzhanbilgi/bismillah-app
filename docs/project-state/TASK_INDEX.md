...
| TASK 083 | **NEXT** | CP10 | Today task UI — first surface for the plan engine. Open sequencing note: generation is still not connected to persistence or onboarding completion, and no dedicated task is named for that wiring | roadmap CP10 | run TASK 083 |
