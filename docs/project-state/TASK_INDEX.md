...
| TASK 084 | **NEXT** | CP10 | Missed-day recovery and gentle rollover — owns day navigation, deferred here by TASK 083, and must learn to recover the typed `rangeConflict` state introduced by TASK 083A. Generation wiring gap is now CLOSED | roadmap CP10 | run TASK 084 |
