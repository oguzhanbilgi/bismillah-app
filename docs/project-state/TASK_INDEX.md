...
| TASK 082 | **NEXT** | CP10 | Learn plan items — third `DailyPlanItemSource`; joins the composite after Prayer and Quran; **published + source-verified** Learn article IDs only | roadmap CP10 | run TASK 082 |
